...
@app.route('/venues/create', methods=['GET']) #done - already implemented
...
@app.route('/artists/create', methods=['GET']) #done - already implemented
...
@app.route('/shows/create') #done - already implemented
def create_shows():
